...
class CustomerRoutes extends BaseRoutes {
    public routes(): void {
        ...
        this.router.get("/:customer_id/getCustomerById", CustomerController.getCustomerById);
        this.router.post(
            "/createCustomer",
        ...
        this.router.delete("/:customer_id/deleteCustomer", CustomerController.deleteCustomer);
    }
}
